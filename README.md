...
轻变计划适合希望减少无意识打开短视频、社交等容易分心应用的 Android 用户。

它采用类似 one sec 的温和干预思路。打开选定应用时，轻变计划会先显示干预界面；用户可以取消使用，如果仍需继续，可以完成当前干预，并选择本次使用目的和允许时长。

轻变计划支持中文界面，可通过应用宝、官网 APK 和 GitHub Release 下载安装。
...
以下截图展示轻变计划的主要产品功能。不同版本的界面细节可能略有差异。
